...
<div class="container my-5">
    ...
    <h3 class="mb-3">Erabiltzaile zerrenda</h3>

    @foreach($usuarios as $user)
        <div class="d-flex justify-content-between align-items-center border rounded shadow-sm px-3 py-2">
            <div class="d-flex align-items-center gap-3">
                @if($user->rol == 1)
                    <i class="fa fa-user-plus fs-2"></i>
                @elseif($user->rol == 0)
